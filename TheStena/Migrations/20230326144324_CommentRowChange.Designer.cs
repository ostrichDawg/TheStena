...
namespace TheStena.Migrations
{
    ...
    [Migration("20230326144324_CommentRowChange")]
    partial class CommentRowChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TheStena.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4707),
                            Downvotes = 2,
                            Title = "Dog's post 1",
                            Upvotes = 4
                        },
                        new
                        {
                            Id = 2,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4709),
                            Downvotes = 7,
                            Title = "Dog's post 2",
                            Upvotes = 60
                        },
                        new
                        {
                            Id = 3,
                            AuthorId = 2,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4710),
                            Downvotes = 30,
                            Title = "Cat's post 1",
                            Upvotes = 15
                        });
            ...
            modelBuilder.Entity("TheStena.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4588),
                            Name = "Dog",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4607),
                            Name = "Cat",
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 3, 26, 20, 43, 24, 357, DateTimeKind.Local).AddTicks(4619),
                            Name = "Admin",
